...
st.set_page_config(
    page_title="Arsip Nasional RI - Asisten Penelusuran Arsip", page_icon="🤖"
)
...
def display_main_content() -> None:
    ...
    st.title("Asisten Penelusuran Arsip 📄🤖")
    st.markdown(
        """
        Selamat Datang di Aplikasi Penelusuran Arsip Berbasis AI 👋

        Aplikasi ini memungkinkan Anda untuk berinteraksi secara langsung dengan asisten berbasis AI 
        dan mengunggah dokumen untuk di proses dan ditemukan kembali.

        **Fitur:**
        - **Chatbot**: Dapat melakukan percakapan dengan asisten AI menggunakan model LLM yang dioptimalkan khusus untuk domain kearsipan.
        - **Upload Dokumen**: Mengunggah dokumen PDF dan mengambil informasinya menggunakan OpenSearch sebagai Sistem RAG Hybrid.
...
def display_sidebar_content() -> None:
    ...
    st.sidebar.markdown(
        "<h4 style='text-align: center;'>--Asisten Penelusuran Arsip</h4>",
        unsafe_allow_html=True,
    )
    st.sidebar.markdown(
        """
